...
for ($i=0; $i <= $#ARGV; $i++) {
	...
	if (/<!--X-NavButtons-Start-->/) {
		...
		print OUT qq|<img src="blank.gif"|,
			  qq|border=0 alt="[Prev]">|;
	    }
	    print OUT '&nbsp;&nbsp;&nbsp;</nobr></td>';
	    print OUT qq|<td align="center" width="99%">|,
qq|<a href="mhonarc.html"><img src="up.gif" border=0 alt="[TOC]"></a>|,
qq|<a href="faq/faq.html"><img src="faq.gif" border=0 alt="[FAQ]"></a>|,
qq|<a href="app-bugs.html"><img src="bug.gif" border=0 alt="[Bugs]"></a>|,
qq|<a href="http://www.mhonarc.org/">|,
qq|<img src="home.gif" border=0 alt="[Home]"></a>|,
		      qq|</td>|;
		...
		print OUT qq|<img src="blank.gif" border=0 alt="[Next]">|;
	    }
